...
parser.add_argument(
    "--out_dir", type=str, default="data", help="Path to librispeech root directory"
)
...
def main(args):
    ...
    create_local_metadata(librimix_dir, out_dir)


def create_local_metadata(librimix_dir, out_dir="data"):
    ...
    for md_dir in md_dirs:
        ...
        for md_file in md_files:
            ...
            local_path = os.path.join(
                out_dir, os.path.relpath(md_dir, librimix_dir), subset
            ).replace("/metadata", "")
